...
def dijkstra(graph1, src, route):
    distances: dict = {node: math.inf for node in route}  # Initialize distances of vertices in the route to infinity
    ...
    while min_heap:
        ...
        neighbors = [neighbor for neighbor in graph1.edge_weight[current_vertex].keys() if neighbor in route]
        # Iterate over the neighbors of the current_vertex and their corresponding weights
        for neighbor in neighbors:
            weight = graph1.edge_weight[current_vertex][neighbor]
